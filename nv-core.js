...
(function () {
  ...
  var chatTree = {
    ...
    safe: { msg: "174 passing tests. Non-custodial. No admin keys. Open-source. On-chain yield verification.", pills: [
  ...
  var knowledgeBase = [
    ...
    { keys: ['safe','security','secure','trust','hack','risk','audit'], answer: "NexVault has 174 passing contract tests. It's fully non-custodial \u2014 your funds stay in the smart contract, only your wallet can withdraw. No admin withdrawal keys exist. The code is open source on GitHub. A CertiK audit is planned." },
    ...
    { keys: ['open source','github','code','contract','verify'], answer: "All NexVault smart contracts are open source on GitHub at github.com/NexVaultGH/nexvault-contracts. 174 passing tests cover deposits, withdrawals, yield, compounding, badges, referrals, and security edge cases." },
